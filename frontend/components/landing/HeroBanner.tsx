      ...
      <div className="relative hidden md:block">
        <ContainerScroll titleComponent={<HeroTitle />}>
          <div className="relative">
            {/* Glow behind mock */}
            <div
              className="pointer-events-none absolute left-1/2 z-0 w-[80%]"
              style={{ top: "-15%", transform: "translateX(-50%)" }}
            >
              <div className="glow-light h-[300px] w-full rounded-full" />
            </div>
            {/* Mock */}
      ...
      <div className="relative px-6 md:hidden">
          ...
          titleComponent={
            <div className="mx-auto max-w-lg text-center">
              ...
              <p className="mt-4 text-base leading-relaxed text-slate-600 dark:text-slate-400">
                Add photos, audio, and animations. Protect with passwords,
                schedule delivery, and share with a link or QR code.
              </p>
        ...
        >
          <div className="relative">
            ...
            >
              <div className="glow-light h-[200px] w-full rounded-full" />
            </div>
            <div className="relative z-10">
              <CardPreviewMock />
            </div>
